! function(n) {
    ...
    t.prototype.updateOutput = function(t) {
        ...
        n("#nestable_list_1").nestable({
            group: 1
        }).on("change", this.updateOutput), n("#nestable_list_2").nestable({
            group: 1
        }).on("change", this.updateOutput), this.updateOutput(n("#nestable_list_1").data("output", n("#nestable_list_1_output"))), 
